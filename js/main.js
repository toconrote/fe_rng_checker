...
const KEY_FEGBA_CH = "fegba_ch"
const KEY_FEGBA_LAST = "fegba_last_selected"
...
var ud=[
["エイリーク",70,40,60,60,30,30,60,2],
["ゼト",85,50,45,45,40,30,25,2],
["ギリアム",90,40,30,30,55,20,30,2],
["フランツ",80,40,40,50,25,20,40,2],
["モルダ",85,40,50,45,25,25,20,2],
["ヴァネッサ",50,35,55,60,20,30,50,2],
["ロス",70,50,35,25,25,20,40,2],
["ガルシア",80,65,40,20,25,15,40,2],
["ネイミー",55,45,50,60,15,35,50,2],
["コーマ",75,40,40,65,25,20,45,2],
["アスレイ",55,60,50,40,15,60,25,2],
["ルーテ",45,70,30,45,15,45,45,2],
["ナターシャ",50,60,25,40,15,55,60,2],
["ヨシュア",80,30,55,55,20,20,30,2],
["エフラム",80,55,55,45,35,25,50,2],
["フォルデ",80,40,50,45,20,25,35,2],
["カイル",85,50,40,40,25,20,20,2],
["ターナ",65,45,40,65,20,25,60,2],
["アメリア",70,40,40,40,30,15,50,2],
["ヒーニアス",60,40,40,45,20,25,45,2],
["ジスト",90,45,40,30,35,25,30,2],
["テティス",85,5,10,70,30,75,80,2],
["マリカ",75,25,50,55,15,20,50,2],
["ラーチェル",45,60,45,50,15,50,65,2],
["ドズラ",85,50,35,40,30,25,30,2],
["サレフ",50,30,25,40,30,35,40,2],
["ユアン",50,55,40,35,15,40,50,2],
["クーガー",85,55,40,45,25,15,35,2],
["レナック",60,25,45,60,25,25,25,2],
["デュッセル",85,55,40,30,45,30,20,2],
["ノール",70,50,40,35,10,45,20,2],
["ミルラ",130,90,85,65,150,30,30,2],
["シレーネ",70,35,50,60,20,50,30,2],
["ケセルダ",85,50,45,45,30,20,20,2],
["オルソン",80,55,45,40,45,30,25,2],
["アーヴ",75,45,50,40,20,45,15,2],
["イシュメア",75,30,60,55,20,25,30,2],
["セライナ",85,40,55,40,20,25,25,2],
["グレン",85,40,50,45,25,40,20,2],
["ヘイデン",70,40,40,45,25,25,40,2],
["ヴァルター",80,40,55,50,20,20,15,2],
["ファード",85,55,40,30,45,25,25,2],
["リオン",85,50,10,10,10,15,30,2],
["エリウッド",80,45,50,40,30,35,45,1],
["ロウエン",90,30,30,30,40,30,50,1],
["マーカス",65,30,50,25,15,35,30,1],
["レベッカ",60,40,50,60,15,30,50,1],
["ドルカス",80,60,40,20,25,15,45,1],
["バアトル",85,50,35,40,30,25,30,1],
["ヘクトル",90,60,45,35,50,25,30,1],
["オズイン",90,40,30,30,55,30,35,1],
["セーラ",50,50,30,40,15,55,60,1],
["マシュー",75,30,40,70,25,20,50,1],
["ギィ",75,30,50,70,15,25,45,1],
["マリナス",120,0,90,90,30,15,100,1],
["エルク",65,40,40,50,20,40,30,1],
["プリシラ",45,40,50,40,15,50,65,1],
["リン",70,40,60,60,20,30,55,1],
["ウィル",75,50,50,40,20,25,40,1],
["ケント",85,40,50,45,25,25,20,1],
["セイン",80,60,35,40,20,20,35,1],
["フロリーナ",60,40,50,55,15,35,50,1],
["レイヴァン",85,55,40,45,25,15,35,1],
["ルセア",55,60,50,40,10,60,20,1],
["カナス",70,45,40,35,25,45,25,1],
["ダーツ",70,65,20,60,20,15,35,1],
["フィオーラ",70,35,60,50,20,50,30,1],
["ラガルト",60,25,45,60,25,25,60,1],
["ニニアン",85,5,5,70,30,70,80,1],
["イサドラ",75,30,35,50,20,25,45,1],
["ヒース",80,50,50,45,30,20,20,1],
["ラス",80,50,40,50,10,25,30,1],
["ホークアイ",50,40,30,25,20,35,40,1],
["ガイツ",85,50,30,40,20,20,40,1],
["ワレス",70,45,40,20,35,35,30,1],
["ファリナ",75,50,40,45,25,30,45,1],
["パント",50,30,20,40,30,35,40,1],
["ルイーズ",60,40,40,40,20,30,30,1],
["カレル",70,30,50,50,10,15,30,1],
["ハーケン",80,35,30,40,30,25,20,1],
["ニノ",55,50,55,60,15,50,45,1],
["ジャファル",65,15,40,35,30,30,20,1],
["ヴァイダ",60,45,25,40,25,15,30,1],
["カアラ",60,25,45,55,10,20,40,1],
["ニルス",85,5,5,70,30,70,80,1],
["レナート",60,40,30,35,20,40,15,1],
["アトス",0,0,0,0,0,0,0,1],
["ロイ",80,40,50,40,25,30,60,0],
["マーカス",60,25,20,25,15,20,20,0],
["アレン",85,45,40,45,25,10,40,0],
["ランス",80,40,45,50,20,15,35,0],
["ウォルト",80,40,50,40,20,10,40,0],
["ボールス",90,30,30,40,35,10,50,0],
["マリナス",100,0,50,50,20,5,100,0],
["エレン",45,50,30,20,5,60,70,0],
["ディーク",90,40,40,30,20,15,35,0],
["ワード",75,50,45,20,30,5,45,0],
["ロット",80,30,30,35,40,15,30,0],
["シャニー",45,30,55,60,10,25,60,0],
["チャド",85,50,50,80,25,15,60,0],
["ルゥ",50,40,50,50,15,30,35,0],
["クラリーネ",40,30,40,50,10,40,65,0],
["ルトガー",80,30,60,50,20,20,30,0],
["サウル",60,40,45,45,15,50,15,0],
["ドロシー",85,50,45,45,15,15,35,0],
["スー",55,30,55,65,10,15,50,0],
["ゼロット",75,25,20,20,30,15,15,0],
["トレック",85,40,30,35,30,5,50,0],
["ノア",75,30,45,30,30,10,40,0],
["アストール",90,35,40,50,20,20,15,0],
["リリーナ",45,75,20,35,10,35,50,0],
["ウェンディ",85,40,40,40,30,10,45,0],
["バース",100,60,25,20,40,2,20,0],
["オージェ",85,40,30,45,20,15,55,0],
["フィル",75,25,50,55,15,20,50,0],
["シン",75,45,50,50,10,15,25,0],
["ゴンザレス",90,60,15,50,25,5,35,0],
["ギース",85,50,30,40,20,10,40,0],
["クレイン",60,35,40,45,15,25,50,0],
["ティト",60,40,45,55,15,20,40,0],
["ララム",70,10,5,70,20,30,80,0],
["エキドナ",75,30,25,30,15,15,20,0],
["エルフィン",80,5,5,65,25,55,65,0],
["バアトル",70,40,20,30,20,5,20,0],
["レイ",55,45,55,40,15,35,15,0],
["キャス",80,40,45,85,15,20,50,0],
["ミレディ",75,50,50,45,20,5,25,0],
["パーシバル",75,30,25,35,20,10,20,0],
["セシリア",60,35,45,25,20,25,25,0],
["ソフィーヤ",60,55,40,30,20,55,20,0],
["イグレーヌ",70,35,25,35,10,5,20,0],
["ガレット",70,45,25,25,15,5,15,0],
["ファ",130,90,85,65,30,50,150,0],
["ヒュウ",75,30,30,45,20,15,25,0],
["ツァイス",80,60,50,35,25,5,20,0],
["ダグラス",60,30,30,30,30,5,20,0],
["ニイメ",25,15,15,15,15,20,5,0],
["ダヤン",55,20,20,15,10,10,20,0],
["ユーノ",50,20,35,30,10,10,45,0],
["ヨーデル",20,30,15,10,10,20,20,0],
...
function ver_OnChange(){
  var ver = Number($("#version").val())
  var unitSelect = $("#unitname")
  unitSelect.empty()
  for(var i=0;i<ud.length;i++){
    if (ud[i][8] != ver) continue
...
$(function(){
  ...
  $("#version").val(lastSelect["version"])
  ver_OnChange()
  $("#unitname").val(lastSelect["unit"][lastSelect["version"]])
